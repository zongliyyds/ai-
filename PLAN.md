...
- **W1 ✅** M1 数据管道+体检（数字与基线逐项一致）｜ M2 检索 v1（BM25+bge-m3 向量+RRF，1,314 chunks）
- **W2 ✅** M3 gold 60 条定稿 + 正式基线（Recall@5=0.8167 / MRR=0.7096 / nDCG@10=0.7403，三项达标）｜ M4 生成链路（[S#] 引用问答 + 超纲拒答，冒烟 4/4）
