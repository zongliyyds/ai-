...
- **W3 ▶ 进行中**：M5 产品层 ✅（FastAPI + Web 问答页/看板，人工验收通过；run_api.bat 一键启动）｜ **M6 六组消融 → 下一步**
- **W4 ⬜** 追加实验（2-hop 深度、分块粒度、规模曲线、本地 vs 云端、联网采集与保鲜模块 B/C）+ M7 工程化/求职转化（GitHub、录屏、简历 bullet、Q&A 预案、**《面试答辩手册 PDF》终期交付物**）
