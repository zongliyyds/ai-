...
## 7. 进度快照（2026-09-16 更新，随 CHANGELOG 走）

- **W1 ✅** M1 数据管道+体检（数字与基线逐项一致）｜ M2 检索 v1（BM25+bge-m3 向量+RRF，1,237 chunks）
- **W2 ✅** M3 gold 60 条定稿 + 正式基线（Recall@5=0.8167 / MRR=0.7010 / nDCG@10=0.7339，三项达标）｜ M4 生成链路（[S#] 引用问答 + 超纲拒答，冒烟 4/4）
...
- **W4 ▶ 下一步**：M7 工程化/求职转化（GitHub、README 指标表、录屏、简历 bullet、Q&A 预案、**《面试答辩手册 PDF》终期交付物**）+ 追加实验（分块粒度 M6b、2-hop、本地 vs 云端、联网采集与保鲜模块 B/C S1 Bing 探测）
