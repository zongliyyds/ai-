...
- **W4 ▶ 进行中**：M7 工程化/求职转化 AI 侧全部交付（README 指标表、简历 bullet 两套、Q&A 预案、**《面试答辩手册 PDF》终期交付物**、env_check、打包红线探针）；**GitHub 已接入**私有仓库 `zongliyyds/ai-`（2026-09-17）+ 新基线（0.8167/0.7096/0.7403）已回写全部文档并改为现场取数防漂移。**剩余 = 用户侧**：3 分钟录屏（7 幕）、简历贴 bullet。AI 侧追加实验：分块粒度 M6b、2-hop、本地 vs 云端、联网采集与保鲜模块 B/C 的 S1 Bing 探测
