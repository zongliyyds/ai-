...
4. **知识卡片草稿**（2026-09 新增，用户要求"完成任务均沉淀、扩充知识库知识"）：把可复用教训写成 Obsidian 风格卡片（frontmatter + 核心观点 + 坑位）放 `reports/knowledge_drafts/`，用户审阅后**手动**复制进 Vault；AI 绝不自动写 Vault——红线不变。
5. **收尾三连问**：手册要改吗？文档要沉淀吗？记忆要更新吗？——坑踩一次不踩第二次。
