...
- 构建个人知识库的数据治理管道：168 篇笔记的**体检基线**（986 H2 / 460 双链 / 29 死链 / 25 孤儿）→ 审计报告与基线逐项一致，增量索引支持笔记持续更新（`reports/audit_report.md`）。
...
- AI 数据分析：「为 168 篇知识库建立评测与归因体系：分层抽样 gold 集 + 四分类 badcase 看板 + 消融归因，坏例命中率分层定位。」
