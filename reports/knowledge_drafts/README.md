...
- `2026-09 切块别拿标题当分隔符：被剥离的标题与没进索引的前缀.md` ✅（2026-09-20 入库）
- `2026-09 消融实验的隔离基建：临时索引、基线闸门与内容指纹.md` ✅（2026-09-20 入库）
- `2026-09 防漂移要覆盖全部展示点：别只验命中，要验覆盖.md` ✅（2026-09-20 入库）
- `2026-09 本地多服务端口隔离：launcher 探活要验特征.md` ✅（2026-09-20 入库）
- `2026-09 检索模式选择：弱路融合会稀释强路信号.md` ✅（2026-09-20 入库）
