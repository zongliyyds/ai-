...
> 生成时间：2026-09-17 14:56 ｜ 数据源（只读）：`D:\AI-Knowledge-Vault\AI-Knowledge-Vault` ｜ 复现命令：`D:\python\python.exe -m vaultmind.ingest`
...
|---|---|---|---|
| 笔记数 | 167 | 167 | ✓ 一致 |
| 总字符 | 297064 | 297064 | ✓ 一致 |
| 正文字符 | 264280 | 264280 | ✓ 一致 |
| H2 节数 | 980 | 980 | ✓ 一致 |
| H3 节数 | 264 | 264 | ✓ 一致 |
| 双链出链 | 455 | 455 | ✓ 一致 |
| 死链 | 29 | 29 | ✓ 一致 |
| 预估 chunk 数（H2+1/篇） | 1147 | 1147 | ✓ 一致 |
