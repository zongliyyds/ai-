...
> 生成时间：2026-09-17 18:12 ｜ 数据源（只读）：`D:\AI-Knowledge-Vault\AI-Knowledge-Vault` ｜ 复现命令：`D:\python\python.exe -m vaultmind.ingest`
...
|---|---|---|---|
| 笔记数 | 168 | 168 | ✓ 一致 |
| 总字符 | 299669 | 299669 | ✓ 一致 |
| 正文字符 | 266681 | 266681 | ✓ 一致 |
| H2 节数 | 986 | 986 | ✓ 一致 |
| H3 节数 | 264 | 264 | ✓ 一致 |
| 双链出链 | 460 | 460 | ✓ 一致 |
| 死链 | 29 | 29 | ✓ 一致 |
| 预估 chunk 数（H2+1/篇） | 1154 | 1154 | ✓ 一致 |
...
| links 行数 | 460 |
| FTS5 索引行数 | 1321 |
| 索引库 | `D:\RAG\data\vaultmind.db`（1976.0 KB） |
