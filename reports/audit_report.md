...
> 生成时间：2026-09-17 16:07 ｜ 数据源（只读）：`D:\AI-Knowledge-Vault\AI-Knowledge-Vault` ｜ 复现命令：`D:\python\python.exe -m vaultmind.ingest`
...
|---|---|---|---|
| 笔记数 | 168 | 167 | ✗ 不一致 |
| 总字符 | 299669 | 297064 | ✗ 不一致 |
| 正文字符 | 266681 | 264280 | ✗ 不一致 |
| H2 节数 | 986 | 980 | ✗ 不一致 |
| H3 节数 | 264 | 264 | ✓ 一致 |
| 双链出链 | 460 | 455 | ✗ 不一致 |
| 死链 | 29 | 29 | ✓ 一致 |
| 预估 chunk 数（H2+1/篇） | 1154 | 1147 | ✗ 不一致 |
...
14. `50-Logs/2026-09-17 VaultMind 知识沉淀入库与检索索引更新.md`
15. `60-References/职场关键能力课程论文项目.md`
16. `10-Projects/vaultmind-rag/README.md`
17. `60-References/CET-4 知识库参考笔记.md`
18. `50-Logs/2026-09-01 王克力求职自我介绍PPT制作.md`
19. `10-Projects/python-learning-lab/capstone/project_spec.md`
...
| links 行数 | 460 |
| FTS5 索引行数 | 1321 |
| 索引库 | `D:\RAG\data\vaultmind.db`（1944.0 KB） |
...
4. **修复失效双链**：29 条出链指向不存在的笔记（死链率 6.3%），建议逐一修复或删除。
